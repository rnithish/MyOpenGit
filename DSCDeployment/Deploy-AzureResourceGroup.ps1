...
Param(
    ...
    [string] $ResourceGroupName = 'DSCDeployment',
...
if ($DeploymentErrors)
{
    $("", "Deployment Errors Summary:") | ForEach-Object { Write-Output $_ }
    $DeploymentErrors | ForEach-Object { Write-Output $_.Exception.Message.TrimEnd("`r`n") }
}